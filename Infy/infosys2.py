...
Original file is located at
    https://colab.research.google.com/drive/13mI_VTQJ-do18wxKNLAm_WN2WcUuqZHJ
"""
...
model_config = "/content/yolov4.cfg"

# Path to config file

model_weights = "/content/yolov4.weights" # Path to weights file
...
# Load pre-trained DNN model (example with YOLOv4-tiny)
model_config = "/content/yolov4.cfg"  # Path to config file
model_weights = "/content/yolov4.weights"  # Path to weights file
net = cv2.dnn.readNetFromDarknet(model_config, model_weights)
...
while cap.isOpened():
    ...
    if count > 500:  # Limit to 100 frames for testing
        break
